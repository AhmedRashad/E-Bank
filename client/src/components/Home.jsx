...
export default function Home() {
  return (
    <div
      id="About"
      className="relative mt-24 flex flex-col sm:flex-row-reverse"
    >
      ...
      <div className="sm:w-7/12">
        <div className="relative px-4 sm:px-6 lg:px-8 text-left">
          <h1 className="text-4xl font-semibold text-PWhite sm:text-5xl lg:text-7xl w-11/12 sm:w-2/3">
            ...
            <span className="text-Gold">easy</span> <span>online payments</span>
          </h1>
          ...
          <div id="Features" className="text-PWhite text-lg mt-16 flex">
            <span className="ml-4 font-semibold">
              ...
              <span className="text-Gold font-bold lg:text-2xl">120,000</span>{" "}
              Companies{" "}
            </span>
            <span className="border-dashed border-l font-bold ml-4 pl-4">
              120k <p className="font-normal">Customers</p>
            </span>
            <span className="border-dashed border-l font-bold ml-4 pl-4">
              40k <p className="font-normal">Total Downloads</p>
            </span>
          </div>
        </div>
      </div>
