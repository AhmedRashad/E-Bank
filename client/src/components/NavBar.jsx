    ...
    <Popover className="sticky top-0 z-50 bg-primary">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="flex justify-between items-center py-2 md:justify-start md:space-x-10">
          <div className="flex justify-start lg:w-0 lg:flex-1">
            ...
            <a href="#" className="text-base font-medium text-PWhite hover:text-Gold">
              Solutions
            </a>
            <a href="#" className="text-base font-medium text-PWhite hover:text-Gold">
              Pricing
                        ...
                        <div className="relative grid gap-6 bg-primary px-5 py-6 sm:gap-8 sm:p-8">
                          {MoreMenu.map((item) => (
                            ...
                            >
                              ...
                              <div className="ml-4">
                                <p className="text-base font-medium text-PWhite">{item.name}</p>
                                <p className="mt-1 text-sm text-PWhite">{item.description}</p>
                              </div>
                            </a>
                          ))}
                        </div>
          ...
          <div className="flex items-center justify-end md:flex-1">
            <a href="#" className="text-base font-medium p-3 text-primary bg-Gold rounded-xl hover:opacity-80">
              Login
            </a>
          </div>
        </div>
      ...
      >
        <Popover.Panel focus className="absolute top-0 inset-x-0 p-2 transition transform origin-top-right md:hidden">
          <div className="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 bg-primary divide-y-2 divide-PWhite">
          </div>
        </Popover.Panel>
      </Transition>
    </Popover>
